...
<head>
    ...
    <link rel="stylesheet" href="/bundles/app/css/icomoon-social.css">
    <link href='http://fonts.googleapis.com/css?family=Open+Sans:400,700,600,800' rel='stylesheet' type='text/css'>

    <link rel="stylesheet" href="/bundles/app/css/leaflet.css" />
    <!--[if lte IE 8]>
    <link rel="stylesheet" href="/bundles/app/css/leaflet.ie.css" />
    <![endif]-->
                ...
                <ul>
                    ...
                    <li>
                        <div class="dropdown choose-country">
                            <a class="#" data-toggle="dropdown" href="#"><img src="/bundles/app/img/flags/gb.png" alt="Great Britain"> UK</a>
                            <ul class="dropdown-menu" role="menu">
                                <li role="menuitem"><a href="#"><img src="/bundles/app/img/flags/us.png" alt="United States"> US</a></li>
                                <li role="menuitem"><a href="#"><img src="/bundles/app/img/flags/de.png" alt="Germany"> DE</a></li>
                                <li role="menuitem"><a href="#"><img src="/bundles/app/img/flags/es.png" alt="Spain"> ES</a></li>
                            </ul>
                        </div>
                    </li>
    ...
    <div id="sequence">
        <ul class="sequence-canvas">
            ...
            <li class="bg4">
                ...
                <!-- Slide Image -->
                <img class="slide-img" src="/bundles/app/img/homepage-slider/slide1.png" alt="Slide 1" />
            </li>
            <!-- End Slide 1 -->
            <!-- Slide 2 -->
            <li class="bg3">
                ...
                <!-- Slide Image -->
                <img class="slide-img" src="/bundles/app/img/homepage-slider/slide2.png" alt="Slide 2" />
            </li>
            <!-- End Slide 2 -->
            <!-- Slide 3 -->
            <li class="bg1">
                ...
                <!-- Slide Image -->
                <img class="slide-img" src="/bundles/app/img/homepage-slider/slide3.png" alt="Slide 3" />
            </li>
            <!-- End Slide 3 -->
        </ul>
...
<script>window.jQuery || document.write('<script src="/bundles/app/js/jquery-1.9.1.min.js"><\/script>')</script>
<script src="/bundles/app/js/bootstrap.min.js"></script>
<script src="http://cdn.leafletjs.com/leaflet-0.5.1/leaflet.js"></script>
<script src="/bundles/app/js/jquery.fitvids.js"></script>
<script src="/bundles/app/js/jquery.sequence-min.js"></script>
<script src="/bundles/app/js/jquery.bxslider.js"></script>
<script src="/bundles/app/js/main-menu.js"></script>
<script src="/bundles/app/js/template.js"></script>
